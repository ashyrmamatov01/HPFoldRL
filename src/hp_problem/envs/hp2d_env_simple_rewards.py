...
class HP2DEnv(gym.Env):
    ...
    def reset(self, *, seed: Optional[int] = None, options=None):
        ...
        return obs, {"valid_actions": valid_mask}
    ...
    def step(self, action: int):
        ...
        terminated = self.step_idx == self.n_res
        reward = 0.0
        if terminated:
            reward = float(self._energy())
            return self.grid.copy(), reward, True, False, {"valid_actions": mask}
